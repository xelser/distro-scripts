...
sudo pacman -Syyu --needed --noconfirm plymouth-theme-manjaro ttf-noto-nerd noto-fonts qt5ct kvantum \
	power-profiles-daemon mhwd dconf-editor redshift warpinator geany transmission-gtk firefox
