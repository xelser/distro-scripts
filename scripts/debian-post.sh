...
sed -i 's/Iosevka/Ubuntu Mono/g' $HOME/.config/rofi/launchers/type-4/shared/fonts.rasi
...
sed -i 's/JetBrains Mono/Ubuntu Mono/g' $HOME/.config/rofi/powermenu/type-1/shared/fonts.rasi
