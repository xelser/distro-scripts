...
xfconf-query -cn xfce4-panel -pn /plugins/plugin-4 -t string -s "pager"
xfconf-query -cn xfce4-panel -pn /plugins/plugin-4/miniature-view -t bool -s "false"
xfconf-query -cn xfce4-panel -pn /plugins/plugin-5 -t string -s "tasklist"
xfconf-query -cn xfce4-panel -pn /plugins/plugin-5/flat-buttons -t bool -s "true"
xfconf-query -cn xfce4-panel -pn /plugins/plugin-5/show-handle -t bool -s "false"
xfconf-query -cn xfce4-panel -pn /plugins/plugin-6 -t string -s "separator"
xfconf-query -cn xfce4-panel -pn /plugins/plugin-6/expand -t bool -s "true"
xfconf-query -cn xfce4-panel -pn /plugins/plugin-6/style -t uint -s "0"
xfconf-query -cn xfce4-panel -pn /plugins/plugin-7 -t string -s "systray"
xfconf-query -cn xfce4-panel -pn /plugins/plugin-7/icon-size -t int -s "25"
xfconf-query -cn xfce4-panel -pn /plugins/plugin-7/menu-is-primary -t bool -s "true"
xfconf-query -cn xfce4-panel -pn /plugins/plugin-7/square-icons -t bool -s "true"
xfconf-query -cn xfce4-panel -pn /plugins/plugin-8 -t string -s "pulseaudio"
xfconf-query -cn xfce4-panel -pn /plugins/plugin-9 -t string -s "notification-plugin"
xfconf-query -cn xfce4-panel -pn /plugins/plugin-10 -t string -s "power-manager-plugin"
xfconf-query -cn xfce4-panel -pn /plugins/plugin-11 -t string -s "separator"
xfconf-query -cn xfce4-panel -pn /plugins/plugin-12 -t string -s "clock"
xfconf-query -cn xfce4-panel -pn /plugins/plugin-12/digital-layout -t uint -s "3"
xfconf-query -cn xfce4-panel -pn /plugins/plugin-12/digital-time-font -t string -s "Fira Sans Bold 11"
xfconf-query -cn xfce4-panel -pn /plugins/plugin-12/digital-time-format -t string -s "%I:%M %p"
xfconf-query -cn xfce4-panel -pn /plugins/plugin-13 -t string -s "separator"
xfconf-query -cn xfce4-panel -pn /plugins/plugin-14 -t string -s "actions"
xfconf-query -cn xfce4-panel -pn /plugins/plugin-14/appearance -t uint -s "0"
xfconf-query -cn xfce4-panel -pn /plugins/plugin-14/items -t string -t string -s "+lock-screen" -s "+logout"
...
xfconf-query -cn xfce4-panel -pn /panels/panel-1/plugin-ids -t int -s "1" -t int -s "2" -t int -s "3" -t int -s "4" -t int -s "5" -t int -s "6" -t int -s "7" -t int -s "8" -t int -s "9" -t int -s "10" -t int -s "11" -t int -s "12" -t int -s "13" -t int -s "14"
xfce4-panel -r
