...
dconf write /org/gnome/shell/extensions/caffeine/inhibit-apps "['io.github.celluloid_player.Celluloid.desktop', 'org.mozilla.firefox.desktop', 'com.google.Chrome.desktop']"
