...
gsettings set org.gnome.builder.editor font-name 'UbuntuMono Nerd Font 11.5'
gsettings set org.gnome.builder.terminal font-name 'UbuntuMono Nerd Font 11.5'
