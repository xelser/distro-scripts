...
# xsettings
xfconf-query -cn xfwm4 -pn /general/theme -t string -s "Edge-blue-light"
xfconf-query -cn xsettings -pn /Net/ThemeName -t string -s "Edge-blue-light"
...
gsettings set org.gnome.desktop.interface gtk-theme 'Edge-blue-light'
...
# gtk4
theme_dir="/usr/share/themes/Edge-blue-light"
...
# flatpak
rm -rf $HOME/.local/share/themes/Edge-blue-light
cp -rf ${theme_dir} $HOME/.local/share/themes/
	
flatpak override --user --env=GTK_THEME=Edge-blue-light
